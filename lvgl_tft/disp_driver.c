...
void *disp_driver_init(void)
{
    ...
    il3820_init();
#elif defined CONFIG_LV_TFT_DISPLAY_CONTROLLER_IL3897
    il3897_init();
...
#elif defined CONFIG_LV_TFT_DISPLAY_CONTROLLER_IL3897
    il3897_flush(drv, area, color_map);
#elif defined CONFIG_LV_TFT_DISPLAY_CONTROLLER_RA8875
...
#elif defined CONFIG_LV_TFT_DISPLAY_CONTROLLER_IL3897
    il3897_set_px_cb(disp_drv, buf, buf_w, x, y, color, opa);
#elif defined CONFIG_LV_TFT_DISPLAY_CONTROLLER_JD79653A
